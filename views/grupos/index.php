...
$(document).ready(function(){
    ...
    $(".add-new").click(function(){
        ...
        var row = '<tr>' +
            ...
            '<td><input type="text" class="form-control" name="group" id="group"></td>' +
			'<td>' + actions + '</td>' +
        '</tr>';
    	$("table").append(row);		
    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2><center>Alta De <b>Grupos</b></h2></div></center>
                    <div class="col-sm-4">
